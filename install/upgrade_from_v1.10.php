...
$alter_user_id = "ALTER TABLE conges_users ADD id_user INT(11) NOT NULL AUTO_INCREMENT FIRST, ADD INDEX(id_user);";
$res_alter_user_id = \includes\SQL::query($alter_user_id);

$alter_user_login = "alter table conges_users drop primary key, ADD PRIMARY KEY(id_user), ADD UNIQUE(u_login);";
$res_alter_user_login = \includes\SQL::query($alter_user_login);

$drop_index_inutile = "drop index id_user on conges_users;";
$res_drop_index_inutile = \includes\SQL::query($drop_index_inutile);

$alter_echange = "ALTER TABLE conges_echange_rtt ADD id_user INT(11) NULL";
...
$alter_user_echange = "ALTER TABLE conges_echange_rtt CHANGE id_user id_user INT(11) NOT NULL";
$res_alter_user_echange = \includes\SQL::query($alter_user_echange);

$alter_pk_echange = "alter table conges_echange_rtt drop primary key, ADD PRIMARY KEY(id_user,e_date_jour);";
...
$alter_edition = "ALTER TABLE conges_edition_papier ADD id_user INT(11) NULL";
...
$alter_groupe_grd_resp = "ALTER TABLE conges_groupe_grd_resp ADD id_user INT(11) NULL";
...
$alter_groupe_resp = "ALTER TABLE conges_groupe_resp ADD id_user INT(11) NULL";
...
$alter_groupe_users = "ALTER TABLE conges_groupe_users ADD id_user INT(11) NULL";
...
$alter_logs = "ALTER TABLE conges_logs ADD id_user_par INT NULL, ADD `id_user_pour` INT NULL";
...
$alter_periode = "ALTER TABLE conges_periode ADD id_user INT(11) NULL";
...
$alter_solde = "ALTER TABLE conges_solde_user ADD id_user INT(11) NULL FIRST";
...
$alter_solde = "ALTER TABLE conges_solde_user CHANGE id_user id_user INT(11) NOT NULL";
$res_alter_solde = \includes\SQL::query($alter_solde);

$alter_pk_solde = "alter table conges_solde_user drop primary key, ADD PRIMARY KEY(id_user,su_abs_id);";
...
$alter_additionnelle = "ALTER TABLE heure_additionnelle ADD id_user INT(11) NULL";
...
$alter_repos = "ALTER TABLE heure_repos ADD id_user INT(11) NULL";
